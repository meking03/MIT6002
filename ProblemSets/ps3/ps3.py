...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        # determine the tile given the position in the rectangular room
        ...
        if capacity >= self.tiles[(pos_x, pos_y)]:
            ...
            self.tiles[(pos_x, pos_y)] = self.tiles[(pos_x, pos_y)] - capacity
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        if (pos_x, pos_y) in self.furniture_tiles:
            return True
        else:
            return False
    ...
    def get_random_position(self):
        ...
        while (math.floor(pos_x), math.floor(pos_y)) in self.furniture_tiles:
            pos_x = random.random() * self.width
            pos_y = random.random() * self.height
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
        # calculate where the robot would be
        new_pos = self.position.get_new_position(self.direction, self.speed)

        # if it is a valid position, move there and clean the tile
        ...
        # otherwise, rotate the robot to be pointing in a random new direction, don't clean the tile
        else:
...
class FaultyRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        if self.gets_faulty():
            # does not clean the tile
            # randomly changes direction
            new_direction = random.random() * 360
            self.set_robot_direction(new_direction)
        else:
            # if the robot is not faulty, acts like a standard robot
            # move to new position
            new_pos = self.position.get_new_position(
                self.direction, self.speed)

            # if the new_pos is valid:
            if self.room.is_position_valid(new_pos):
                # set robot position
                self.set_robot_position(new_pos)
                # clean the tile
                ...
                # set a new direction without cleaning the tile
                new_direction = random.random() * 360
                self.set_robot_direction(new_direction)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                FaultyRobot)
    """
    # simulate num_trials amount of simulations
    time_passed = []
    for trial in range(num_trials):
        ...
        #     num_robots, width, height, furniture_tiles=[])
        ...
        time_passed.append(clock_ticks)
        # anim.done()

    return sum(time_passed) / len(time_passed)


# print('avg time steps: ' + str(run_simulation(1,
#                                               1.0, 1, 5, 5, 3, 1, 50, StandardRobot)))
# print('avg time steps: ' + str(run_simulation(1,
#                                               1.0, 1, 10, 10, 3, 0.8, 50, StandardRobot)))
# print('avg time steps: ' + str(run_simulation(1,
#                                               1.0, 1, 10, 10, 3, 0.9, 50, StandardRobot)))
# print('avg time steps: ' + str(run_simulation(1,
#                                               1.0, 1, 20, 20, 3, 0.5, 50, StandardRobot)))
# print('avg time steps: ' + str(run_simulation(3,
#                                               1.0, 1, 20, 20, 3, 0.5, 1, StandardRobot)))
